...
if(preg_match("/admin/i",$_SESSION["user"]))
{
	...
	echo "<script>( window.parent || window ).location = 'health_view.php';</script>";
}
$sql="select * from health where reg_no='".$_SESSION['user']."';";
...
{
	echo '<iframe src="health.html" style="width:100%;height:100%"></iframe>';
}
$conn->close();
?>
</div>
