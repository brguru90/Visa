...
if(preg_match("/admin/i",$_SESSION["user"]))
{
	...
	echo "<script>( window.parent || window ).location = 'bankloan_view.php';</script>";
}
$sql="select * from bankloan where reg_no='".$_SESSION['user']."';";
...
{
	echo '<iframe src="bankloan.html" style="width:100%;height:100%"></iframe>';
}
$conn->close();
?>
</div>
