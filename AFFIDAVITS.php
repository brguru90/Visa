...
if(preg_match("/admin/i",$_SESSION["user"]))
{
	...
	echo "<script>( window.parent || window ).location = 'affidavits_view.php';</script>";
}
$sql="select * from affidavit where reg_no='".$_SESSION['user']."';";
...
{
	echo '<iframe src="AFFIDAVITS.html" style="width:100%;height:100%"></iframe>';
}
$conn->close();
?>
</div>
