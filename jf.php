...
if(preg_match("/admin/i",$_SESSION["user"]))
{
	...
	echo "<script>( window.parent || window ).location = 'jewel_view.php';</script>";
}
$sql="select * from jewel where reg_no='".$_SESSION['user']."';";
...
{
	echo '<iframe src="jewel.html" style="width:100%;height:100%"></iframe>';
}
$conn->close();
?>
</div>
