...
if(preg_match("/admin/i",$_SESSION["user"]))
{
	...
	echo "<script>( window.parent || window ).location = 'ielts_view.php';</script>";
}
$sql="select * from ielts where reg_no='".$_SESSION['user']."';";
...
{
	echo '<iframe src="ielts.html" style="width:100%;height:100%"></iframe>';
}
$conn->close();
?>
</div>
