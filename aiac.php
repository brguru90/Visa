...
<div id="apDiv17">
  <h2>
    <center style='color:green;font-weight:bold;font-size:40px'>
      Additional Industry Accredited Courses
    </center>
  </h2>
  <p> </p>
  <ul style="font-size:25px;">
    <li> Chem-Cert Certificate - a two day course for horticulturists working in   the industry - includes purchasing, handling, correct application   methods and storage of chemicals (integrated pest and disease management   issues are also covered). </li>
    <li> Level 1 Workplace First Aid Course. </li>
    <li> Level 2 Workplace First Aid Course. </li>
    <li> Cardio Pulmonary Resuscitation (CRP) Annual Update. </li>
    <li> Occupational Health &amp; Safety Course. </li>
    <li> Managing Farm Safety Course. </li>
  </ul>
</div>
<?php
