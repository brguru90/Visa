...
if(preg_match("/admin/i",$_SESSION["user"]))
{
	...
	echo "<script>( window.parent || window ).location = 'pass_view.php';</script>";
}
$sql="select * from pass where reg_no='".$_SESSION['user']."';";
...
{
	echo '<iframe src="pass.html" style="width:100%;height:100%"></iframe>';
}
$conn->close();
?>
</div>
